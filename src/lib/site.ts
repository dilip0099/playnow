...
// production domain is chosen (see the GamePix ads.txt note: no domain decided as of yet).
export const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://playnow.example.com";
