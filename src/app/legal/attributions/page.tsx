...
export const metadata: Metadata = {
  ...
  description: "Every game on PlayNow is licensed via GameMonetize. This page lists the source, license, and catalog ID for each title.",
};
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="space-y-2 border-b border-border/60 pb-6">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Every game on PlayNow is licensed through <strong className="text-foreground">GameMonetize</strong>, a third-party HTML5 game publisher network — PlayNow does not author this game code, only embeds it under a publisher agreement. Each title below links to its real GameMonetize catalog entry and ID so its origin is fully traceable.
          </p>
        </div>
