...
export const metadata: Metadata = {
  ...
  description: "License distribution, GamePix sourcing registry, trademark risk scans, and commercial readiness audit.",
};
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="space-y-2 border-b border-border/60 pb-6">
          ...
          <p className="text-sm text-slate-400">
            License distribution, GamePix sourcing registry, and trademark safety scans.
          </p>
        </div>
